    ...
    if (empty($username) || empty($password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($result->num_rows > 0) {
                ...
                try {
                    // Insert user
                    $stmt = $conn->prepare("INSERT INTO users (username, password_hash, wallet_address, is_admin) VALUES (?, ?, ?, 0)");
                    $stmt->bind_param("sss", $username, $hashed_password, $wallet_address);
                    $stmt->execute();
...
<head>
    ...
    <title>ESP32 Blockchain - Register</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="requirements">
            ...
            <ul>
                ...
                <li>Start with 0 ESP32 tokens</li>
                <li>Mine to earn rewards!</li>
            </ul>
        </div>
